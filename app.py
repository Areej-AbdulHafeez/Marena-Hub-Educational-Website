...
# Actual quiz-by-course route (was missing - /quiz/<course> used to 404)
@app.route('/quiz/<course>')
def quiz_by_course(course):
    template = COURSE_TEMPLATES.get(course.lower())
    if not template:
        return f"<h1>404 - Quiz Not Found</h1><p>No quiz for '{course}'.</p>", 404
